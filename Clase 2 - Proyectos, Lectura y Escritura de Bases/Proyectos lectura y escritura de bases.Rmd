...
```{r message=FALSE, warning=FALSE}
setwd("C:/Users/usuario/Desktop/Guido/Trabajo/Repositorios de R/Cursos de R/Diplomatura UNSAM/Modulo 1/Fuentes")
getwd()
```
...
![](img/nuevo%20proyecto.png){width="410"}![](img/nuevo%20proyecto2.png){width="410"}\
...
**Sugerencia:** para trabajar con bases muy pesadas (el caso de la base que se encuentra en la carpeta "Fuentes"), Explorar los parámetros que permiten levantar una cantidad límitada de filas. Para lo que sigue aquí, tomaremos solo los primeros 10.000 casos de la base

```{r}
base.casos.covid <- read_csv("../Fuentes/Covid19Casos.csv",
                             n_max = 10000)
```
...
base_tweets <- readRDS(file = "../Fuentes/Bases adicionales/vacuna.tweets.RDS")
