...
d. Crear una tabla en base a la población anterior que contenga, para cada provincia:
...
e. Crear una variable recodificando la variable **edad** en 5 rangos etáreos.
```{r}

```


f. Dado el siguiente código, agregar una columna con el valor del peso relativo de cada provincia respecto al total:
