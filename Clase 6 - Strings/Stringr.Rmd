...
###str_extract 
La funciones `str_extract` y `str_extract_all` nos permiten extraer de nuestros strings, determinados patrones especí¿ificados.     
...
Remplacemos todo aquello que no es una palabra por un espacio
```{r}
